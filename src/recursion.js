...
var reverse = function(string) {
  ...
  var lastElement = string.slice(-1);
...
var modulo = function(x, y) {
  ...
  // figure out how to accept negative numbers
...
var compareStr = function(str1, str2) {
  ...
  var lastChar1 = str1.slice(-1);
  var lastChar2 = str2.slice(-1);

  if (lastChar1 !== lastChar2) {
    return false;
  }

  var remainingStr1 = str1.slice(0, -1);
  var remainingStr2 = str2.slice(0, -1);

  return compareStr(remainingStr1, remainingStr2);
};
...
var reverseArr = function(array) {
  ...
  return result.concat(reverseArr(arrCopy));
};
...
var rMap = function(array, callback) {
  ...
  var lastChar = arrCopy.pop();
  result.push(callback(lastChar));

  return (rMap(arrCopy, callback)).concat(result);
};
